// Re-export the main compatibility shim so legacy imports work:
// import { ... } from "@/lib/email-marketing/cosmic"
export * from "../cosmic";
...
export const isCosmicConfigured = !!(
  process.env.COSMIC_BUCKET_SLUG &&
  process.env.COSMIC_READ_KEY &&
  process.env.COSMIC_WRITE_KEY
);

// Create the Cosmic client and export it (only if configured)
