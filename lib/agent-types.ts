// Agent types for Pegasus II-Agent integration
...
export type ActionStep = {
  ...
  // Additional raw payload used widely by the UI and event handlers
  // to store tool_input, result, and flags like isResult
  data?: Record<string, any>;
};

export interface Message {
  id: string;
  type: "user" | "assistant" | "system" | "thinking" | "action";
  // Optional role field for chat UIs which use role instead of type
