...
import { getEmailCampaign, updateCampaignStatus, updateEmailCampaign } from "@/lib/cosmic";
...
export async function POST(request: NextRequest, { params }: RouteParams) {
  try {
    ...
    // Persist initial stats snapshot separately
    await updateEmailCampaign(id, { stats: { sent: 0, opened: 0, clicked: 0, bounced: 0, unsubscribed: 0, open_rate: "0%", click_rate: "0%" } });
