...
import { getMarketingCampaigns, syncCampaignTrackingStats } from "@/lib/email-marketing/cosmic";
// Cron endpoints use headers (authorization) — treat as dynamic to avoid build-time prerender
