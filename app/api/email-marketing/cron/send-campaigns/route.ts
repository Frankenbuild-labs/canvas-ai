...
// Cron endpoints use request.headers and may access DB/external services; treat as dynamic
...
} from "@/lib/email-marketing/cosmic";
import { sendEmail, ResendRateLimitError } from "@/lib/resend";
import { createUnsubscribeUrl, addTrackingToEmail } from "@/lib/email-marketing/email-tracking";
import { MarketingCampaign, EmailContact } from "@/lib/email-marketing/types";
