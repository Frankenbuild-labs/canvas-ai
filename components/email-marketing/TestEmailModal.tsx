...
export default function TestEmailModal({
    ...
    try {
      ...
      const response = await fetch("/api/email-marketing/settings", {
        ...
        body: JSON.stringify({
          ...
          // Add test emails as comma-separated string
          test_emails: validEmails.join(", "),
        }),
      });
  ...
  const handleSendTest = async () => {
    ...
    try {
      ...
      setSuccess(
        `Test emails sent successfully to ${result.stats.sent} of ${result.stats.total} recipients!`
      );
      ...
      <DialogContent className="sm:max-w-[500px]">
              ...
              <div className="flex items-start space-x-2">
                ...
                <div>
                  ...
                  <ul className="text-sm text-blue-700 mt-1 space-y-1">
                    ...
                    <li>
                      • Test emails are saved to your settings for future use
                    </li>
                  </ul>
                </div>
              </div>
        ...
        <DialogFooter className="flex space-x-2">
          ...
          <Button
            ...
            disabled={
              isSending || isLoadingEmails || testEmailsInput.trim() === ""
            }
