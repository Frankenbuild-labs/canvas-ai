  ...
  return (
    <>
      <div className="w-full overflow-x-auto">
        <div
          className={`toolbar-container flex items-center gap-1 p-2 bg-card border border-border rounded-lg shadow-sm min-w-max ${className}`}
          onMouseDown={(e) => e.preventDefault()} // Prevent focus loss when clicking toolbar
        >
          {/* Text Styles Dropdown */}
          <div className="flex items-center pr-1 border-r border-border flex-shrink-0">
            <Select
              onValueChange={(value) => {
                handleFormat(value);
              }}
          ...
          <div className="hidden md:flex items-center px-1 border-r border-border flex-shrink-0">
            <Select
              value={fontFamily}
              onValueChange={(value) => {
          ...
          <div className="flex items-center px-1 border-r border-border flex-shrink-0">
            <Select
              onValueChange={(value) => {
                handleFormat(value);
              }}
      ...
      >
        <DialogContent className="sm:max-w-[900px] max-h-[85vh] flex flex-col">
          ...
          <div className="flex justify-end space-x-2 pt-4 border-t border-border flex-shrink-0 bg-card">
            <Button
              variant="outline"
              onClick={() => {
                setImageDialog({ url: "", alt: "", link: "", isOpen: false });
