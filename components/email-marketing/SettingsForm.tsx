...
import { Settings, UpdateSettingsData } from "@/lib/email-marketing/types";
import {
  AlertCircle,
  CheckCircle,
  Mail,
...
export default function SettingsForm({ initialSettings }: SettingsFormProps) {
  ...
  const [formData, setFormData] = useState<UpdateSettingsData>({
    ...
    primary_brand_color:
      initialSettings?.metadata.primary_brand_color || "#3b82f6",
    secondary_brand_color:
      initialSettings?.metadata.secondary_brand_color || "#1e40af",
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (
      formData.test_emails &&
      typeof formData.test_emails === "string" &&
      formData.test_emails.trim()
    ) {
      ...
      if (invalidTestEmails.length > 0) {
        setError(
          `Invalid test email addresses: ${invalidTestEmails.join(", ")}`
        );
        return;
      }
    }
              ...
              <CardContent className="space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    ...
                    />
                    <p className="text-xs text-gray-500">
                      Where replies will be sent (defaults to from email if
                      empty)
                    </p>
                  </div>
              ...
              <CardContent className="space-y-4">
                <div className="space-y-3">
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      handleInputChange("test_emails", e.target.value)
                    }
                    disabled={isPending}
                    className="w-full"
                  />
                  ...
                  <p className="text-xs text-gray-500">
                    Enter comma-separated email addresses for testing campaigns.
                    These addresses will be available for testing campaigns in
                    draft mode.
                  </p>
                    ...
                    <div className="flex items-start space-x-2">
                      ...
                      <div>
                        ...
                        <ul className="text-sm text-blue-700 mt-1 space-y-1">
                          <li>
                            • Only available for campaigns in Draft status
                          </li>
                          ...
                          <li>
                            • Test banner is added to identify test emails
                          </li>
                          <li>
                            • Saved addresses are automatically loaded for
                            future tests
                          </li>
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  />
                  <p className="text-xs text-gray-500">
                    Physical address for CAN-SPAM compliance (required for
                    commercial emails)
                  </p>
                </div>
              </CardContent>
          ...
          <TabsContent value="branding" className="space-y-6">
            <Card>
              <CardHeader>
                ...
                <p className="text-sm text-gray-600">
                  Define your brand voice and visual identity for AI-generated
                  content
                </p>
              </CardHeader>
              <CardContent className="space-y-4">
                <div className="space-y-2">
                  ...
                  />
                  <p className="text-xs text-gray-500">
                    Detailed brand guidelines to help AI generate content that
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    <Label htmlFor="primary_brand_color">
                      Primary Brand Color
                    </Label>
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="secondary_brand_color">
              ...
              <CardContent className="space-y-4">
                <div className="space-y-2">
                  ...
                  <Select
                    ...
                    ) => handleInputChange("ai_tone", value)}
                  >
                    <SelectTrigger>
                ...
                <div className="p-4 bg-blue-50 border border-blue-200 rounded-lg">
                  <h4 className="font-medium text-blue-900 mb-2">
                    How AI uses your settings:
                  </h4>
                  <ul className="text-sm text-blue-800 space-y-1">
                    <li>
                      • Brand guidelines help AI match your voice and style
                    </li>
                    <li>
                      • Brand colors are applied to buttons and design elements
                    </li>
                    <li>• Company name and tone personalize the content</li>
                    <li>
                      • All settings work together to create on-brand emails
                    </li>
                  </ul>
                </div>
              </CardContent>
